...
export default function Home() {
	return (
		<main className="w-full h-full relative">
			...
			<div className="w-full p-2 lg:p-5 top-0 left-0 absolute z-50">
				<div className=" py-24 sm:py-32 rounded-md drop-shadow-xl bg-slate-50/30 border border-slate-50/20">
